...
def start_screen():
    ...
    medium_select_text = other_font.render("Medium", True, (5, 0, 0))
...
def lose_game():
    win_font = pygame.font.SysFont("Garamond", 75)
    win_title = win_font.render("Game Over!", True, (0, 0, 0))
    screen.blit(win_title, (50, 100))
    exit_font = pygame.font.SysFont("Impact", 25)
    exit_select_text = exit_font.render("Restart", True, (0, 0, 0))
